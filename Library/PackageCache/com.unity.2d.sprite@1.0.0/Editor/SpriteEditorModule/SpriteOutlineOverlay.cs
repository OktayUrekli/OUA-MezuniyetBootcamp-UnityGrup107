...
{
    internal class SpriteOutlineToolOverlayPanel : VisualElement
    {
        public class SpriteOutlineToolOverlayPanelFactory : UxmlFactory<SpriteOutlineToolOverlayPanel, UxmlTraits> {}
